...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -2134182829L;
    ...
    public QUser(Class<? extends User> type, PathMetadata metadata, PathInits inits) {
        ...
        this.profilePhoto = inits.isInitialized("profilePhoto") ? new QProfilePhoto(forProperty("profilePhoto"), inits.get("profilePhoto")) : null;
    }
