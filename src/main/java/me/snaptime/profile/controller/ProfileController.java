...
public class ProfileController {
    ...
    @Parameter(name = "writerLoginId", description = "앨범과 사진들을 가져오기 위한 writerLoginId", required = true)
    ...
    @Parameter(name = "writerLoginId", description = "이름과 프로필 사진을 가져오기 위한 writerLoginId", required = true)
    @GetMapping("/profile")
    ...
    @Parameter(name = "writerLoginId", description = "팔로워와 팔로잉 수를 가져오기 위한 writerLoginId", required = true)
    @GetMapping("/count")
